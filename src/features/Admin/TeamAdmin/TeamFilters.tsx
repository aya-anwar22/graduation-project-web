// src/components/admin/TeamFilters.tsx
import React from 'react';

// تعريف نفس نوع الفلاتر
...
export const TeamFilters: React.FC<Props> = ({
    filters,
    onFilterChange,
    onReset,
    supervisors,
            ...
            <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="flex gap-2 flex-wrap">
                    <select
                        ...
                        disabled={loading}
                        className="px-4 cursor-pointer py-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-red-500 disabled:opacity-50"
                    >
                    ...
                    <button
                        onClick={onReset}
                        disabled={loading}
                        className="px-4 cursor-pointer py-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 transition-all disabled:opacity-50 flex items-center gap-2"
                        title="إعادة تعيين"
                    >
