...
const Sidebar: React.FC = () => {
    ...
    const navItems: NavItem[] = [
        ...
        // { id: 5, name: 'الإشعارات', icon: 'mdi:bell', path: '/notifications', badge: 3 },
            ...
            `} role="navigation" aria-label="القائمة الرئيسية">
                ...
                <div className="p-4 border-t border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
                    ...
                    {/* <button
                        ...
                        className="flex items-center justify-center gap-3 px-4 py-2.5 mt-3 rounded-xl bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all w-full"
